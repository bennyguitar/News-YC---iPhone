...
- (void)didClickChangeTheme:(HNThemeType)type {
    [HNTheme changeThemeToType:type];
...
- (void)didClickMySubmissions {
    PostsViewController *vc = [[PostsViewController alloc] initWithNibName:@"PostsViewController" bundle:nil username:[HNManager sharedManager].SessionUser.Username];
